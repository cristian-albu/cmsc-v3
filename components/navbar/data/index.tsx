...
export const navbarData: Readonly<T_NavItem[]> = [
  ...
  {
    [E_LANG.RO]: "Proiecte și programe",
    [E_LANG.EN]: "Projects and programs",
    link: E_PATHS.PROJECTS,
  },
  {
    [E_LANG.RO]: "Asistență victime",
    [E_LANG.EN]: "Victim assistance",
    link: E_PATHS.SERVICES,
  },
  { [E_LANG.RO]: "Resurse", [E_LANG.EN]: "Resources", link: E_PATHS.RESOURCES },
  { [E_LANG.RO]: "Evenimente", [E_LANG.EN]: "Events", link: E_PATHS.EVENTS },
  {
    [E_LANG.RO]: "Emotional Treasure Box",
    [E_LANG.EN]: "Emotional Treasure Box",
    link: E_PATHS.EMOTIONAL_TREASURE_BOX,
  },
