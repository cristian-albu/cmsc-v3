...
const ContactPage: FC = () => {
  ...
  //   const isCorrectElementType =
  //     e.target instanceof HTMLInputElement ||
  //     e.target instanceof HTMLTextAreaElement;
  //   const isPartOfStructure = Object.values(E_FORM_NAMES).includes(
  //     e.target.name as E_FORM_NAMES
  //   );
  ...
  //   const privacyValidation = validateAcceptedPrivacy(
  //     formState[E_FORM_NAMES.privacy_agreement]
  //   );
          ...
          {/* {!isSuccess ? (
            ...
            >
              ...
              {errorList.length > 0 && (
                <div>
                  <Typography level={3}>
                    ❗{langState === E_LANG.EN ? "Errors:" : "Erori:"}
                  </Typography>
